...
class SelectServiceAdapter(var list:MutableList<SelectServiceData>,var viewModel: SelectServiceViewModel):BaseRecyclerAdapter<SelectServiceData,SelectServiceViewHolder>(list) {
